...
/*-----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
bool OgreApp::initializeRTShaderSystem(Ogre::SceneManager* sceneMgr)
{			
...
void OgreApp::startOgre()
{
	new OgreFramework();
	if(!OgreFramework::getSingletonPtr()->initOgre("OgreApp v1.0", this, 0))
		return;
    
	m_bShutdown = false;
    
	OgreFramework::getSingletonPtr()->m_pLog->logMessage("Ogre initialized!");
